...
export default function DashBoardSidebar({ activeTab, setActiveTab }: SidebarProps) {
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <aside
                className={`fixed md:static top-0 left-0 h-screen bg-white shadow-md border-r w-64 p-4 flex flex-col gap-4 transform transition-transform duration-300 z-40
